...
public class MathurakPlanetGenerator extends PlanetGenerator
{
    ...
    public Block[][] arr =
    {
    {FormBlocks.faermWall, FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faermWall, FormBlocks.faerm},
    {FormBlocks.DarkBlueSand, FormBlocks.faermWall, FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faermWall, FormBlocks.faerm, FormBlocks.faerm},
    {FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand, FormBlocks.faermWall, FormBlocks.DarkBlueSand, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faermWall, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faerm},
    {FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand, FormBlocks.faermWall, FormBlocks.faerm, FormBlocks.faermWall, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faerm},
    {FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand, FormBlocks.faermWall, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faerm, FormBlocks.faerm}
    };

    ObjectMap<Block, Block> dec = ObjectMap.of(
        FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand,
        FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand,
        FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand,
        FormBlocks.DarkBlueSand, FormBlocks.DarkBlueSand
    );
    ...
    ObjectMap<Block, Block> tars = ObjectMap.of(
        FormBlocks.faerm, FormBlocks.faerm,
        FormBlocks.faerm, FormBlocks.faerm
    );
    ...
    public Color getColor(Vec3 position){
        ...
        if(block == FormBlocks.faerm) return Blocks.sand.mapColor;
    ...
    protected void generate(){
                        ...
                        for(int y = -rad; y <= rad; y++){
                            ...
                            if(Structs.inBounds(wx, wy, width, height) && Mathf.within(x, y, rad)){
                                ...
                                if(Mathf.within(x, y, rad - 1) && !other.floor().isLiquid){
                                    ...
                                    other.setFloor((Floor)(floor == FormBlocks.DarkBlueSand || floor == FormBlocks.faerm ? FormBlocks.DarkBlueSand : FormBlocks.DarkBlueSand));
                                }
                            }
                        }
                    }
        ...
        pass((x, y) -> {
            ...
            if(ore == FormBlocks.oreLithium && rand.chance(0.33)){
        ...
        pass((x, y) -> {
            ...
            }else if(genLakes && floor != FormBlocks.DarkBlueSand && floor != FormBlocks.faerm && floor.asFloor().hasSurface()){
                float noise = noise(x + 782, y, 5, 0.75f, 260f, 1f);
                if(noise > 0.67f && !roomseq.contains(e -> Mathf.within(x, y, e.x, e.y, 14))){
                    if(noise > 0.72f){
                        floor = noise > 0.78f ? Blocks.taintedWater : (floor == FormBlocks.DarkBlueSand ? FormBlocks.DarkBlueSand : FormBlocks.DarkBlueSand);
                    }else{
