...
public class FormBlocks {
    ...
    //environment & ores
    oreLithium, faerm, faermWall, DarkBlueSand, distilledwater, fueloli, wallOrelithium, orePlatinum, faermBoulder, orerubyGreen, pinksand, redstone,
    //units
    foidgroundFactory,
    //storage
    coretomer,
    ...
    public static void load() {
        ...
        redstone = new Floor("red-stone") {{
			...
			faermWall = new StaticWall("faerm-wall"){
        };
			faerm = new Floor("faerm"){{
            variants = 3;
		...
		faermBoulder = new Prop("faerm-Boulder"){{
            variants = 2;
            faerm.asFloor().decoration = DarkBlueSand.asFloor().decoration = this;
        }};
		//Endenvironment
